...
namespace TMSNextLevel.webrefMStrongCreates {
    using System;
    ...
    public partial class WebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback ReceiveTenderOperationCompleted;
        ...
        /// <remarks/>
        public WebService() {
            this.Url = "http://mstrongcreates.com/webservice.asmx";
        ...
        /// <remarks/>
        public event ReceiveTenderCompletedEventHandler ReceiveTenderCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://mstrong.tk/ReceiveTender", RequestNamespace="http://mstrong.tk", ResponseNamespace="http://mstrong.tk", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string ReceiveTender(string pickupdateandtime, string dropoffdateandtime, string pickuplocation, string dropofflocation, int compid) {
            object[] results = this.Invoke("ReceiveTender", new object[] {
                        pickupdateandtime,
                        dropoffdateandtime,
                        pickuplocation,
                        dropofflocation,
        ...
        /// <remarks/>
        public void ReceiveTenderAsync(string pickupdateandtime, string dropoffdateandtime, string pickuplocation, string dropofflocation, int compid) {
            this.ReceiveTenderAsync(pickupdateandtime, dropoffdateandtime, pickuplocation, dropofflocation, compid, null);
        }
        
        /// <remarks/>
        public void ReceiveTenderAsync(string pickupdateandtime, string dropoffdateandtime, string pickuplocation, string dropofflocation, int compid, object userState) {
            if ((this.ReceiveTenderOperationCompleted == null)) {
                this.ReceiveTenderOperationCompleted = new System.Threading.SendOrPostCallback(this.OnReceiveTenderOperationCompleted);
            }
            this.InvokeAsync("ReceiveTender", new object[] {
                        pickupdateandtime,
                        dropoffdateandtime,
                        pickuplocation,
                        dropofflocation,
                        compid}, this.ReceiveTenderOperationCompleted, userState);
        }
        
        private void OnReceiveTenderOperationCompleted(object arg) {
            if ((this.ReceiveTenderCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.ReceiveTenderCompleted(this, new ReceiveTenderCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2558.0")]
    public delegate void ReceiveTenderCompletedEventHandler(object sender, ReceiveTenderCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2558.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class ReceiveTenderCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal ReceiveTenderCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
