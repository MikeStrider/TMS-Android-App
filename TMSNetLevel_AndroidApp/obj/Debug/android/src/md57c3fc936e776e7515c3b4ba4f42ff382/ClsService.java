package md57c3fc936e776e7515c3b4ba4f42ff382;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ClsService, TMSNetLevel_AndroidApp", ClsService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ClsService.class)
			mono.android.TypeManager.Activate ("ClsService, TMSNetLevel_AndroidApp", "", this, new java.lang.Object[] {  });
	}
